...
namespace Gilzoide.PrefabPool.Internal
{
        ...
        where TPool : APrefabPool<T>, new()
    {
        ...
        IReadOnlyCollection<Object> IPrefabPool.ActiveInstances => _pool.ActiveInstances;
        IReadOnlyCollection<Object> IPrefabPool.InactiveInstances => _pool.InactiveInstances;
